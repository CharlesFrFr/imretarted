...
func main() {
  ...
  //   profile, err := common.ReadProfileFromUser(c.Param("id"), "athena")
  //   if err != nil {
  //     c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
  //     return
  //   }

  //   // basic example of modifying a profile
  //   // itemNameToModify := "AthenaCharacter:CID_001_Athena_Commando_F_Default"
  //   // if item, found := profile.Items[itemNameToModify]; found {
  //   //     item.TemplateId = "AthenaCharacter:hi"
  //   //     profile.Items[itemNameToModify] = item
  //   // }

  //   helpers.PrintGreen([]string{"profile loaded", profile.Items["AthenaCharacter:CID_001_Athena_Commando_F_Default"].TemplateId})
  ...
  fortnite := r.Group("/fortnite/api")
  {
    ...
    fortnite.GET("/game/v2/enabled_features", func(c *gin.Context) {
      c.JSON(http.StatusOK, []gin.H{})
    })
    fortnite.POST("/game/v2/tryPlayOnPlatform/account/*accountId", func(c *gin.Context) {
      c.String(http.StatusOK, "true")
    })
    fortnite.GET("/storefront/v2/keychain", func(c *gin.Context) {
  ...
  blank := r.Group("/")
  {
    blank.GET("/waitingroom/api/waitingroom", func(c *gin.Context) {
      c.Status(204)
      c.Abort()
    })
    blank.POST("/datarouter/*api", func(c *gin.Context) {
      c.Status(204)
      c.Abort()
    })
    blank.GET("/lightswitch/api/service/bulk/status", func(c *gin.Context) {
      c.JSON(http.StatusOK, []gin.H{{
    ...
    blank.GET("/lightswitch/api/service/Fortnite/status", func(c *gin.Context) {
      c.JSON(http.StatusOK, []gin.H{{
        "serviceInstanceId": "fortnite",
        "status": "UP",
        "message": "fortnite is up.",
